...
# This is still on beta! If you have feedback DM me on discord (lucas11.xyz) or make a Github issue! 
## Why did i make this?
...
## How to install
Download the .blueprint file in releses and install this with this command:
```bash
blueprint install lutheme
```