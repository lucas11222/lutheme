...
## How to install
Download the [.blueprint file in releses](https://github.com/lucas11222/lutheme/releases/download/0.1-beta/lutheme.blueprint) and install this with this command:
```bash
